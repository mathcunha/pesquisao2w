...
public class AppiaService implements Service {
    ...
    private static Logger log = Logger.getLogger(AppiaService.class.getName());
	...
	public AppiaService(String serviceName){
		...
		try {
            ...
            log.log(Level.FINEST, "Error getting the value for the service: "+service);
			e.printStackTrace();
		}
        if(Level.FINEST.equals(log.getLevel()))
            log.log(Level.FINEST, "SERVICE:: "+service+" :: "+value);
	}
