...
public class CacheMarshaller200 extends AbstractMarshaller {
   ...
   /**
    * @param in
    * @return a 2-object array.  The first one is the unmarshalled object and the 2nd is an Fqn that relates to the
    *         region used.  If region-based marshalling is not used, the 2nd value is null.
    * @throws Exception
    */
