...
public class RPCManagerImpl implements RPCManager {
    ...
    */
   private CommandAwareRpcDispatcher_G2CL rpcDispatcher = null;
   ...
   private FlushTracker flushTracker = new FlushTracker_G2CLL();
   ...
   public class FlushTracker_G2CLL implements FlushTracker {
   ...
   private void initialiseChannelAndRpcDispatcher(boolean fetchState) throws JGCSException, FileNotFoundException, IOException {
	   ...
	   FactoryUtil jgcsConf = new FactoryUtil("m:/g2cl-jboss.properties");
       ...
       if (configuration.isUseRegionBasedMarshalling()) {
           ...
           rpcDispatcher = new CommandAwareRpcDispatcher_G2CL(this.dataSession,controlSession, service,
